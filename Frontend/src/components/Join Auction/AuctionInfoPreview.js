...
import './AuctionInfoPreview.css';
import axios from 'axios';
import { baseURL } from "../../http";

const AuctionInfoPreview = () => {
  ...
  return (
    <div className="auctioninfopreview-container">
      <div className="auctioninfopreview-header">
        <button className="auctioninfopreview-back-button" onClick={() => navigate(-1)}>
          <FaArrowLeft /> Back
        </button>
        <h2 className="auctioninfopreview-title">► Auction Information ◄</h2>
      </div>

      <div className="auctioninfopreview-layout-wrapper">
        <div className="auctioninfopreview-layout">
          <div className="auctioninfopreview-box">
            <h2 className="auctioninfopreview-box-header">➤ Auction Details</h2>
          ...
          <div className="auctioninfopreview-box">
            <h2 className="auctioninfopreview-box-header">➤ Auction Rules</h2>
...
export default AuctionInfoPreview;
